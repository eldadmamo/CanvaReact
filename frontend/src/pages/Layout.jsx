        ...
        <div className='bg-[#18191b] min-h-screen w-full'>
                    ...
                    <div className='flex justify-between items-center'>
                        ...
                        <div className='flex gap-4 justify-center items-center relative'>
                            ...
                            <div className={`absolute top-[60px] right-0 w-[300px] bg-[#313030] p-3 border border-gray-700 transition duration-500 ${show? 'visible opacity-100': 'invisible opacity-30'}`}>
                                ...
                                <img className='w-[40px] h-[40px] rounded-full' src='https://png.pngtree.com/png-clipart/20230927/original/pngtree-man-avatar-image-for-profile-png-image_13001877.png' alt='' />
                                <div className='flex justify-center flex-col items-start'>
                                    <span className='text-[#e0dddd] font-bold text-md'>Eldad</span>
                                    <span className='text-[#e0dddd] font-bold text-md'>eldadfikre456@gmail.com</span>
                                </div>
                                </div>
            ...
            <div className='w-full flex mt-16'>
                <div className='sidebar w-[300px] p-5 h-[calc(100vh-70px)] fixed bg-[#34569f]'>
                    ...
                    <img className='w-[48px] h-[45px] rounded-full' src='https://png.pngtree.com/png-clipart/20230927/original/pngtree-man-avatar-image-for-profile-png-image_13001877.png' alt='image' />
                    <div className='flex justify-center flex-col items-start'>
                        <span className='text-[#e0dddd] font-bold text-md'>Eldad Mamo</span>
