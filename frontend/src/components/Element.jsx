...
const Element = ({id,info,exId}) => {
    return (
        <>
         ...
         <div onMouseDown={(info.rotateElement(id,info))} className='hidden absolute group-hover:block -top-[3px] -left-[3px] w-[10px] h-[10px] cursor-nesw-resize bg-gray-600 z-[99999]'>
         </div>
         
        <div onMouseDown={(info.moveElement(id,info))} className='hidden absolute group-hover:block -top-[3px] left-[50%] translate-[-50%,0%] w-[10px] h-[10px] cursor-nesw-resize bg-blue-600 z-[99999]'>
        </div>

        <div onMouseDown={(info.moveElement(id,info))} className='hidden absolute group-hover:block top-[50%] -left-[3px] translate-[-0%,50%] w-[10px] h-[10px] cursor-nesw-resize bg-blue-600 z-[99999]'>
        </div>

        <div onMouseDown={(info.moveElement(id,info))} className='hidden absolute group-hover:block top-[50%] -right-[3px] translate-[0%,-50%] w-[10px] h-[10px] cursor-nesw-resize bg-blue-600 z-[99999]'>
        </div>

        <div onMouseDown={(info.moveElement(id,info))} className='hidden absolute group-hover:block -bottom-[3px] left-[50%] translate-[-50%,0%] w-[10px] h-[10px] cursor-nesw-resize bg-blue-600 z-[99999]'>
        </div>
